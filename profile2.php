            ...
            <table class="profile-detail">
                ...
                ?>
                        <td>
                            <?php
                            if($row['profile_img'] == ''){
                                echo'<img id="pfImage" src="images/user.png" alt="Profile image" onclick="profile_img();" width="105" height="105" />';
                            }else{?>
                                
                                <img id="pfImage" src="<?php echo $row['profile_img']?>" onclick="profile_img();" width="105" height="105"/>
