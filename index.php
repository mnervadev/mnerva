...
include("incl/header.php"); ?>
      <div class="main-content">
        ...
        <div class="main-content_tab-panels">
		 ...
		 <a href="<?php echo BASE_URL; ?>/book/?q=uploads/<?php echo explode('/',$book['upload_file_name'])[1];?>" >
              ...
              <div class="grid-list_row-container">
                 <div class="slick">
				   ...
				   ?>
                  <div class="grid-list_row--item">
				    <a href="<?php echo BASE_URL; ?>/book/?q=uploads/<?php echo explode('/',$trend['upload_file_name'])[1];?>" >
